...
using NTier.Common.Enum.Email;
using NTier.Common.Enum.User;
using NTier.Common.Utility;
using NTier.Core.BindingModels.Account;
using NTier.Core.BindingModels.Common;
using NTier.Core.BindingModels.JqGrid;
using NTier.Core.Notification.Email;
using NTier.Core.Notification.Email.Config;
using NTier.Core.Utility.JqGrid;
using NTier.Core.Utility.Validation;
using NTier.DAL.IdentityManager;
using NTier.DAL.Models.Account;
using NTier.DAL.UnitOfWork;
